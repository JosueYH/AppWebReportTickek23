<div class="header navbar navbar-inverse ">
  <div class="navbar-inner">
    <div class="header-seperation text-center">
      ...
      <h2>
        <a href="dashboard.php" class="text-blue"><strong>Sistema Ticket</strong></a>
      </h2>
    </div>
    <div class="header-quick-nav">
      <div class="ml-2 pull-left" style="padding-top: 0.5em;padding-left: 1em">
        ...
        <h4>
          <a href="./admin/dashboard.php" class="text-reset"><strong>Sistema de Generación de Tickets del Cliente</strong></a>
